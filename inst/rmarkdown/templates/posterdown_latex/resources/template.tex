...
%%%%%%%%% COLOURS %%%%%%%%
%Fill/ Line Colours
\definecolor{titleboxbgcol}{$titlebox_bgcol$}
\definecolor{titleboxbordercol}{$titlebox_bordercol$}
\definecolor{columnlinecol}{$columnline_col$}
\definecolor{bodybgcol}{$body_bgcol$}
\definecolor{sectitlebgcol}{$sectitle_bgcol$}
\definecolor{sectitlebordercol}{$sectitle_bordercol$}
% Text Colours
\definecolor{titletextcol}{$title_textcol$}
\definecolor{authortextcol}{$author_textcol$}
\definecolor{affiliationtextcol}{$affiliation_textcol$}
\definecolor{sectitletextcol}{$sectitle_textcol$}
\definecolor{bodytextcol}{$body_textcol$}
\definecolor{footnotetextcol}{$footnote_textcol$}
\definecolor{citecol}{$cite_col$}
\definecolor{urlcol}{$url_col$}
\definecolor{linkcol}{$link_col$}
